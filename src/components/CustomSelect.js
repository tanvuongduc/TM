...
export const SortStatus = ({ onSelectedSortBy }) => {
  const useStyles = makeStyles((theme) => ({
    formControl: {
      margin: 0,
      color: "black",
  ...
  return (
    <FormControl className={useStyles().formControl}>
      <Select
        ...
        className={useStyles().select}
        onClick={(e) => onSelectedSortBy(e.target.value)}
      >
...
export const SortPriority = ({ onSelectedDirection }) => {
  const useStyles = makeStyles((theme) => ({
    formControl: {
      margin: 0,
      color: "black",
  ...
  return (
    <FormControl className={useStyles().formControl}>
      <Select
        ...
        className={useStyles().select}
        onClick={(e) => onSelectedDirection(e.target.value)}
      >
